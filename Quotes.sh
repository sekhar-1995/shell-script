...
cosider the case of #3
# for Ex:- the "#3", here we want to print the value of word followed by "$", but for $9 there is no value is assigned. 
--> In this case to print the value we will use "\" that will ignore thw special character i.e "$" & print the value
